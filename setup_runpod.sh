...
echo "  • NATS Server: nats://0.tcp.in.ngrok.io:16521"
echo "  • HTTP Polling: https://b5400c821168.ngrok-free.app"
echo "  • Orchestrator API: https://b5400c821168.ngrok-free.app"
echo ""
...
echo "  ✅ Connect to NATS at nats://0.tcp.in.ngrok.io:16521"
echo "  ✅ Detect GPU: NVIDIA RTX 2000 Ada Generation (or mock GPUs)"
