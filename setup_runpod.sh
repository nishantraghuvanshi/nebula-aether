...
echo "  • NATS Server: 0.tcp.in.ngrok.io:15603"
echo "  • HTTP Polling: https://a64286f3cfc6.ngrok-free.app"
echo "  • Orchestrator API: https://a64286f3cfc6.ngrok-free.app"
echo ""
...
echo "  ✅ Connect to NATS at 0.tcp.in.ngrok.io:15603"
